...
*/
	...
	** Bootstrap 95% CI's
	regress sbp c.schlyrs i.female i.black i.latinx c.rameduc c.rafeduc ///
	c.age c.age2 i.southern, vce(bootstrap, reps(500))
	...
	**Bootstrap 95% CIs
	forval i=0.01(0.01)1 {
		
		bsqreg sbp c.schlyrs i.female i.black i.latinx c.rameduc c.rafeduc ///
		c.age c.age2 i.southern, quantile(`i') reps(500)
	...
	**Bootstrap 95% CI's
	forval i=1(1)100 {
		...
		rifhdreg sbp c.schlyrs i.female i.black i.latinx c.rameduc c.rafeduc ///
		c.age c.age2 i.southern, rif(q(`i')) vce(bootstrap, reps(500))
